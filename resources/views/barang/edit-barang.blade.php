                            ...
                            <form action="{{ route('barang.update', $barang->ID_BARANG) }}" method="post">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" value="{{ $barang->NAMA }}" name="nama" id="nama">
                                    </div>
                                    <div class="form-group">
                                        <label for="harga" class="form-control-label">Harga</label>
                                        <input class="form-control" type="number" name="harga" value="{{ $barang->HARGA }}" id="harga">
                                    </div>
                                    <div class="form-group">
                                        <label for="deskripsi" class="form-control-label">Deskripsi</label>
                                        <textarea class="form-control" type="text" name="deskripsi" id="deskripsi">{{ $barang->DESKRIPSI }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_masuk" class="form-control-label">Tanggal Barang Masuk</label>
                                        <input class="form-control" type="date" name="tgl_masuk" value="{{ $barang->TGL_MASUK }}" id="tgl_masuk">
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_keluar" class="form-control-label">Tanggal Barang Keluar</label>
                                        <input class="form-control" type="date" name="tgl_keluar" value="{{ $barang->TGL_KELUAR }}" id="tgl_keluar">
                                    </div>
                                    <div class="form-group">
                                        <label for="status" class="form-control-label">Status</label>
                                        <input class="form-control" type="text" name="status" value="{{ $barang->Status }}" id="status">
                                    </div>
