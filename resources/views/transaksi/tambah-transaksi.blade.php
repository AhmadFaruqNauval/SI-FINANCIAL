                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="id_pengiriman" id="id_pengiriman" value="{{ $id_pengiriman }}" readonly>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="date" name="tgl_transaksi"
                                            id="tgl_transaksi">
                                    </div>
                                    <div class="form-group">
